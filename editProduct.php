                ...
                <div class="card shadow mb-4">
                    ...
                    <?php
                        ...
                        if (isset($_GET['updateID'])) {  
                            ...
                            $id = sanitizeInput($con, $_GET['updateID']);
                        ...
                        ?> 
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-5">
                                    <input type="text" name="ProductName" class="form-control" placeholder="Name of the Product" value="<?php echo $value['name'];?>">
                                        <?php echo '<label class="text-danger">'.$err['ProductName'].'</label>'; ?>
                                    </div>
                                    <div class="col-md-5">
                                    <input type="number" name="ProductPrice" class="form-control"  placeholder="Price of the Product" value="<?php echo $value['price'];?>">
                                ...
                                <div class="row">
                                    ...
                                    <textarea name="ProdDes" class="form-control " id="inputAddress" placeholder="Description"><?php echo htmlspecialchars($value['description']);?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <img class="w-25" src="uploads/<?php echo $value['photo1'];?>">
                                        <br>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <br>
                                        <img class="w-25"src="uploads/<?php echo $value['photo2'];?>">
                                        <br>
                                ...
                                <br>
                                    <div class="row">
                                        <div class="col-md-5">
                                        <button type="submit" name="updatebtn" class="btn btn-success text-white">UPDATE PRODUCT</button>
